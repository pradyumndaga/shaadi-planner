        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-white dark:bg-slate-900">
            ...
            <div className="flex-1 flex items-center justify-center p-8 order-2 md:order-1">
                <div className="w-full max-w-sm animate-fade-in">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-8">Start organizing your wedding today</p>
            ...
            {/* Branding Side */}
            <div className="hidden md:flex md:w-1/2 bg-brand-600 items-center justify-center p-12 text-white relative overflow-hidden order-1 md:order-2">
                <div className="absolute inset-0 opacity-10 pointer-events-none">
                    <div className="absolute top-0 right-0 w-96 h-96 bg-white blur-3xl rounded-full translate-x-1/2 -translate-y-1/2"></div>
